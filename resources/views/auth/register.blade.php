                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nombre del propietario') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Email de acceso') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rol" type="text" class="form-control" name="rol" value="propietario" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nameShop" type="text" class="form-control @error('nameShop') is-invalid @enderror" name="nameShop" value="{{ old('nameShop') }}" required autocomplete="nameShop">
                            </div>
                        </div>
                        <div class="form-group row">
